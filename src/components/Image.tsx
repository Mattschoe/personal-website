...
export interface ImageProps {
  ...
  glyph?: string;
  /** Set for above-the-fold images (hero portrait, featured card, detail
   *  heroes) — loads eagerly with high fetch priority instead of lazily, so
   *  the LCP image isn't deferred. Placeholder-only slots can ignore it. */
  eager?: boolean;
 ...
 */
export function Image({ src, alt = '', tone, label, glyph, className, eager }: ImageProps) {
